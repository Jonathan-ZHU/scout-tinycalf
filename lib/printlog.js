...
exports.err = function(str){
  var colorstring = time(true) + " " + ERR + " " + str;
...
exports.info = function(str){
  var colorstring = time(true) + " " + INFO + " " + str;
...
exports.warn = function(str){
  var colorstring = time(true) + " " + WARN + " " + str;
